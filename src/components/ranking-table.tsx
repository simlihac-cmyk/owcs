  ...
  return (
    <div className="overflow-hidden rounded-[28px] border border-white/60 bg-white/85 shadow-panel backdrop-blur">
      <div className="border-b border-slate-200/80 px-5 py-4">
        <h3 className="text-sm font-semibold uppercase tracking-[0.24em] text-slate-500">현재 순위표</h3>
      </div>
        ...
        <table className="min-w-full text-sm">
          <thead className="bg-slate-50 text-left text-xs uppercase tracking-[0.2em] text-slate-500">
            <tr>
              ...
              <th className="px-4 py-3">승패</th>
              <th className="px-4 py-3">세트</th>
              <th className="px-4 py-3">세트 득실</th>
              <th className="px-4 py-3">전력</th>
            </tr>
          </thead>
          <tbody>
